...
This project made use of the AWS CLI in order to automate and reduce time and complexity.
...
You will need to clone or download [this GitHub repo](https://github.com/udacity/nd063-c3-design-for-security-project-starter) in order to get started with this project.
